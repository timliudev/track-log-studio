...
/**
 * Everything a metric might need to compute itself for a lap. Extend later with
 * `referenceLap` / `sectors` for delta-time and optimal-lap metrics — adding a
 ...
 * are derived from the lap structure / GPS track.
 */
