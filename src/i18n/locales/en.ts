export default {
  ...
  analyzer: {
    ...
    gear: {
      ...
      estimateNotAvailableCvtHint: "A CVT has no discrete gear plateaus to solve for, so circumference can't be back-estimated from the log like MT can (an honest \"not available\" beats a made-up number). Measure the wheel circumference directly, or switch to the MT tab to convert a tire spec, then enter the result here.",
