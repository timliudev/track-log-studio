export default {
  ...
  analyzer: {
    ...
    gear: {
      ...
      ratioLow: 'CVT ratio (low / launch)',
      ratioHigh: 'CVT ratio (high / top)',
      finalReduction: 'Final/gear reduction',
      maxRpm: 'Engine max RPM',
      resultsHeading: 'Results',
      colGear: 'Gear',
      colTotalReduction: 'Total reduction',
      colSpeedAtRedline: 'Speed @ redline',
      topSpeed: 'Theoretical top speed: {speed} (gear {gear})',
      shiftDrop: 'Shift {from}→{to}: {rpm} RPM drop',
      cvtSpeedRange: 'Speed at max RPM: {low} (low) – {high} (top speed)',
      rpmSpeedTable: 'RPM ↔ speed table (gear {gear})',
      invalidSpec: 'Enter a complete, valid spec above to see results.',
      inversionHeading: 'Recover ratio from recording',
      inversionIntro: 'Computes the actual engine-RPM / wheel-RPM ratio over time from the loaded recording.',
      inversionWheelCircumference: 'Wheel circumference (mm)',
      noSession: 'Load a recording to recover its actual drivetrain ratio.',
      noChannels: 'This recording has no RPM and/or speed (GPS_Speed / Vehicle_Speed) channel.',
      ...
      cvtSweepHeading: 'CVT ratio vs. speed',
