export default {
  ...
  analyzer: {
    ...
    addGearRatioChart: 'Add gear-ratio chart',
    removeChart: 'Remove',
    lapCount: 'Laps: {n}',
    ...
    gear: {
      ...
      timelineMovedHint: 'The time/distance ratio trace and lap overlay now use the main chart system; add one with “Add gear-ratio chart” above.',
    ...
    layout: {
      ...
      cardGearRatioChart: 'Gear ratio chart {n}',
      collapse: 'Collapse',
      expand: 'Expand',
