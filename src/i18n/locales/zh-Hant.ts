export default {
  ...
  analyzer: {
    ...
    gear: {
      ...
      gearCount: '檔數',
      gearRatioLabel: '第 {n} 檔齒比',
      frontSprocket: '前齒盤（齒數）',
      rearSprocket: '後齒盤（齒數）',
      wheelCircumference: '後輪周長 (mm)',
      redlineRpm: '紅線／換檔轉速 (RPM)',
      ratioLow: 'CVT 齒比（低速／起步）',
      ratioHigh: 'CVT 齒比（高速／極速）',
      finalReduction: '終傳減速比',
      maxRpm: '引擎最高轉速 (RPM)',
      resultsHeading: '計算結果',
      colGear: '檔位',
      ...
      shiftDrop: '{from}→{to} 檔：轉速降 {rpm} RPM',
      cvtSpeedRange: '最高轉速下的車速：{low}（低速端）– {high}（極速）',
      rpmSpeedTable: '轉速↔車速對照表（第 {gear} 檔）',
      invalidSpec: '請於上方輸入完整且有效的規格以顯示計算結果。',
      inversionHeading: '由記錄反推齒比',
      inversionIntro: '從已載入的記錄計算引擎轉速／後輪轉速的實際比值隨時間變化。',
      inversionWheelCircumference: '後輪周長 (mm)',
      noSession: '請先載入記錄以反推實際傳動比。',
      noChannels: '此記錄缺少轉速及／或速度（GPS_Speed / Vehicle_Speed）頻道。',
