...
| # | 任務 | 分支 | 狀態 |
|---|------|------|------|
| W3a | 依賴更新(npm outdated/audit)+ build 產物驗證(echarts chunk/precache/chunk 尺寸) | chore/deps-and-build-verify | 🔄 進行中(與 Wave 2 並行) |
| W3b | code review(今晚全部 diff)+ 覆蓋補強 | — | ⬜ 等全部合併後串列做 |
